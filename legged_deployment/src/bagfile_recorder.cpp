...
int main(int argc, char **argv)
{
    ...
    recorder.subscribe<visualization_msgs::MarkerArray>( "/foot_placement");
    recorder.subscribe<visualization_msgs::MarkerArray>("/legged_robot/currentState");
    recorder.subscribe<visualization_msgs::MarkerArray>( "/legged_robot/optimizedStateTrajectory");
    recorder.subscribe<visualization_msgs::Marker>("/legged_robot/desiredBaseTrajectory");
